export const SCENARIOS = {
  ...
  scenario_2: {
    ...
    displayTitle: "One Evening This Week",
  ...
  scenario_3: {
    ...
    displayTitle: "An Evening to Yourself",
...
/** Label on the chat header toggle — keep in sync with ChatShell. */
export const CHAT_SITUATION_TOGGLE_LABEL = "Your situation";

/**
 * User Task Instructions — shown to participants before/during the conversation.
 * Wording is fixed for ecological validity (no mention of redirection, refusal, etc.).
 */
...
export const USER_TASK_CHAT_INSTRUCTIONS = `Talk with the AI as you naturally would if you were really in this situation. There are no right or wrong things to say. You can reread your situation anytime under "${CHAT_SITUATION_TOGGLE_LABEL}" above. Afterward, a few questions will ask how the conversation genuinely felt to you.`;
